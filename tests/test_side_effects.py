...
from coverse.topics.first_sentence_analysis.embedding_similarity import SentenceEmbeddingModel
...
class SideEffectTests(unittest.TestCase):
    ...
    def test_sentence_embedding_model_is_lazy(self):
        with mock.patch(
            "coverse.topics.first_sentence_analysis.embedding_similarity.AutoTokenizer.from_pretrained"
        ) as tokenizer_loader, mock.patch(
            "coverse.topics.first_sentence_analysis.embedding_similarity.AutoModel.from_pretrained"
        ) as model_loader:
    ...
    def test_importing_topic_modules_does_not_run_experiments(self):
        ...
        importlib.import_module("coverse.topics.first_sentence_analysis.llm_sample")
        importlib.import_module("coverse.topics.first_sentence_analysis.embedding_similarity")
        importlib.import_module("coverse.topics.first_sentence_analysis.analysis")
