...
实验默认从 `data/first_sentence_analysis/v0/prompt.json` 读取 20 个启动句，整理自三个日常情境：
...
.venv/bin/python coverse/topics/first_sentence_analysis/llm_sample.py \
  --output-path data/first_sentence_analysis/v0/llm_samples.json
```
...
.venv/bin/python coverse/topics/first_sentence_analysis/embedding_similarity.py \
  --samples-path data/first_sentence_analysis/v0/llm_samples.json \
  --output-path data/first_sentence_analysis/v0/embedding_similarities.json
```

```bash
.venv/bin/python coverse/topics/first_sentence_analysis/analysis.py \
  --similarities-path data/first_sentence_analysis/v0/embedding_similarities.json \
  --output-path data/first_sentence_analysis/v0/analysis.json
```
...
```text
data/first_sentence_analysis/v0/prompt.json
```
